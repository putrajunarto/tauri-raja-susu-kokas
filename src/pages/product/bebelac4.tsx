...
export default function Bebelac4() {
  ...
  return (
    <>
      ...
      <img src="/product/bebelac3/section-1.webp" className="img-fluid" alt="placeholder" />
      <img src="/product/bebelac3/section-2.webp" className="img-fluid" onClick={playVideo} alt="placeholder" />
      <img src="/product/bebelac3/section-3.webp" className="img-fluid" alt="placeholder" />
      <img src="/product/bebelac3/section-4.webp" className="img-fluid" onClick={() => setShowGizi(true)} alt="placeholder" />
      {/* Modal Video */}
